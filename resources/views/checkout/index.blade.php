                    ...
                    <div class="row g-4">
                        <div class="col-lg-7">
                            <div class="checkout-card">
                                ...
                                <div class="mb-3">
                                    <label for="shipping_service" class="form-label text-white">Pilih Jasa Pengiriman</label>
                                    <select name="shipping_service" id="shipping_service" class="form-select bg-dark text-white border-secondary"
                                        required>
