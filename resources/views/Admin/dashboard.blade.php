                                ...
                                <tbody>
                                    @forelse ($pesanan_terbaru as $pesanan)
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $statusClass = 'badge-status-proses'; // default
...
@push('scripts')
    ...
    <script>
        ...
        new Chart(salesCtx, {
            type: 'line',
            data: {
                labels: @json($salesChartData['labels']), // Data dari controller
                datasets: [{
                    label: 'Pendapatan',
                    data: @json($salesChartData['data']), // Data dari controller
                    borderColor: '#d4af37',
