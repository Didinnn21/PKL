            ...
            <form action="{{ route('member.products.index') }}" method="GET">
                <div class="row g-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        <button type="submit" class="btn btn-gold-solid w-100 py-2">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card product-card">
                        <div class="product-image-container">
                            {{-- Pastikan path gambar sesuai dengan landing page --}}
                            <img src="{{ asset('images/product/' . $product->image) }}" alt="{{ $product->name }}"
                                onerror="this.src='{{ asset('images/kestore-logo.png') }}'; this.style.objectFit='contain'; this.style.padding='20px';">

                            {{-- Badge Harga Overlay (Opsional, agar lebih terlihat) --}}
                            <div
                                class="position-absolute top-0 end-0 m-3 px-3 py-1 bg-warning text-dark fw-bold rounded-pill shadow small">
                                Stok: {{ $product->stock }}
                            </div>
                        </div>
            ...
            @empty
                <div class="col-12">
                    <div class="text-center py-5 rounded border border-secondary" style="background-color: #141414;">
                        ...
                        <p class="text-secondary">Coba ubah filter harga atau kembali lagi nanti.</p>
